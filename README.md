...
- enable direct print/save from Pdfs in Viewer

v5.1.1:
- bug fix: max_integer
- bug fix: key error translation
- bug fix: crash when title is None
- update portable
...
- automatic .git delete, if database download was aborted
...
v4.7.1:
- bug fix: Permission error when updating DDB on Windows. DDB moved to AppData
- bug fix: Wrong label in WW (Stellenwert)
  
v4.7.0:
- New function in WorksheetWizard: ggT & kgV
- new: change size of solutions in WW
- bug fix: error when creating PFZ
- bug fixes
  
v4.6.6:
- restructure "Zusatzthemen"
- bug fixes
